...
| **OPUS-Dokument&shy;typen** | | | | | **book** (Buch) <br/> **editedCollection** (Sammelband) <br/> **monograph** (Monographie) <br/> **sourceEdition** (Quellenedition) | **bookPart** (Teil eines Buchs/Kapitel) | **conferenceAbstract** (Konferenz: Meeting Abstract) <br/> **conferenceObject** (Konferenzveröffentlichung) <br/> **conferencePaper** (Konferenzpaper) <br/> **conferencePoster** (Konferenzposter) <br/> **conferenceProceedings** (Konferenz-Proceedings) <br/> **conferenceSlides** (Konferenzfolien) | **article** (Wissenschaftl. Artikel) <br/> **contributionToPeriodical** (Beitrag zu nichtwissenschaft. Zeitschrift) <br/> **corrigendum** (Korrigendum) <br/> **dataPaper** (Data Paper) <br/> **editorial** (Vorwort) <br/> **letter** (Letter to the Editor) <br/> **periodicalPart** (Ausgabe/Heft zu einer Zeitschrift) <br/> **preprint** (Preprint) <br/> **researchArticle** (Forschungsartikel) <br/> **reviewArticle** (Übersichtsartikel) <br/> **softwarePaper** (Softwareartikel) | **bachelorThesis** (Bachelorarbeit)<br />**diplom** (Diplomarbeit)<br />**doctoralThesis** (Dissertation)<br />**examen** (Examensarbeit)<br />**habilitation** (Habilitation)<br />**magister** (Magisterarbeit)<br />**masterThesis** (Masterarbeit)<br />**studyThesis** (Studienarbeit) | **workingPaper** (Arbeitspapier) | **annotation** (Entscheidungs-/Urteilsanmerkung) <br/> **courseMaterial** (Lehrmaterial)<br /> **dynamicWebResource** (Dynamische Online-Ressource) <br/> **dynamicWebResourcePart** (Teil einer dynamischen Online-Ressource) <br/> **image** (Bild)<br />**lecture** (Vorlesung)<br />**movingImage** (Bewegte Bilder)<br /> **musicalNotation** (Noten [Musik]) <br/> **other** (Sonstiges) <br/> **periodical** (Periodikum/Zeitschrift)<br /> **report** (Bericht) <br/> **researchData** (Forschungsdaten) <br/> **review** (Rezension) <br/> **software** (Software) <br /> **sound** (Ton) <br/> **website** (Website) |
|-----
